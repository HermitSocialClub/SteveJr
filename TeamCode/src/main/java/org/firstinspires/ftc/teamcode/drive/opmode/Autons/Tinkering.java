...
@Autonomous (name = "Tinkering")
public class Tinkering extends LinearOpMode {
...
//                .ba9-ck(20)
        ...
        TrajectorySequence goToBoardRight = drive.trajectorySequenceBuilder(dropPurpleMid.end())
                .setVelConstraint(velocityConstraint)
                .back(37)
                .build();
            ...
            while (opModeIsActive() && !isStopRequested()) {
                switch (actionIndex) {
                    ...
                    case 4:
                        ...
                        if(Math.abs(drive.spoolEncoder.getCurrentPosition() - 200) > 30) break;
                        actionIndex++;
                        break;
                    case 5:
