...
@Autonomous (name = "ILT BackUpBlue")
public class ILTBackUp extends LinearOpMode {
...
//    SiddyDetector SiddyPosition = null;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence toMiddleSequenceStart = drive.trajectorySequenceBuilder(new Pose2d(starting.vec(),m(-90)))
                .forward(30.5)
                .build();

        TrajectorySequence toMiddleDrop = drive.trajectorySequenceBuilder(toMiddleSequenceStart.end())
                .back(27)
                .turn(m(-90))
                .forward(35)
                .build();
        ...
        waitForStart();
           ...
           if (vision.location == LEFT){
              ...
              // drive.followTrajectory(toLeftButICry);
               ...
               drive.followTrajectorySequence(toMiddleSequenceStart);
               drive.clawFlipper.setPosition(0.8);
               drive.openRightClaw();
               drive.followTrajectorySequence(toMiddleDrop);
