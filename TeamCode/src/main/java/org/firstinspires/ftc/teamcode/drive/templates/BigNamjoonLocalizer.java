 ...
 */
@Config
public class BigNamjoonLocalizer extends ThreeTrackingWheelLocalizer {
    public static double TICKS_PER_REV = 8192;
    public static double WHEEL_RADIUS = .688975; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 10.5;//14.25; //8.75; // in; distance between the left and right wheels
    ...
    public BigNamjoonLocalizer(HardwareMap hardwareMap) {
        ...
        frontEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "spool"));
