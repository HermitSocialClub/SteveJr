...
@Autonomous (name = "BlueClosetoWallMeet3Auton")
public class BlueCloseToWallMeet3Auton extends LinearOpMode {
...
//                })
        ...
        TrajectorySequence plsIWantToSleep = drive.trajectorySequenceBuilder(toMiddleSequence.end())
                .back(32)
                .build();
...
//                })
        ...
        waitForStart();
           ...
           if (vision.location == LEFT){
              ...
              // drive.followTrajectorySequence(plsIWantToSleep);
